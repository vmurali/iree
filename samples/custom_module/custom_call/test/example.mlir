...
module @example {
  //func.func private @Double.function(tensor<?x?xi32>, tensor<?x?xi32>, tensor<?x?xi32>, tensor<?x?xi32>) -> (tensor<?x?xi32>, tensor<?x?xi32>) attributes {
  func.func private @Double.function(tensor<?x?xi32>, tensor<?x?xi32>) -> tensor<?x?xi32> attributes {
    iree.abi.model = "coarse-fences",
    nosideeffects
  }

  //func.func private @Triple.function(tensor<?x?xi32>, tensor<?x?xi32>, tensor<?x?xi32>, tensor<?x?xi32>) -> (tensor<?x?xi32>, tensor<?x?xi32>) attributes {
  func.func private @Triple.function(tensor<?x?xi32>, tensor<?x?xi32>) -> tensor<?x?xi32> attributes {
    iree.abi.model = "coarse-fences",
    nosideeffects
  }
